...
#ifdef CONFIG_WAPI
#define WAPI_IE_VENDOR_TYPE 0x00147201
#endif /* CONFIG_WAPI */
...
/* Wi-Fi display OUI type */
#define WFD_OUI_TYPE			0xA
enum wfd_subelement_id {
	WFD_DEVICE_INFO_SUBELEM_ID = 0,
	WFD_ASSOC_BSSID_SUBELEM_ID = 1,
	WFD_AUDIO_FORMATS_SUBELEM_ID = 2,
	WFD_VIDEO_FORMATS_SUBELEM_ID = 3,
	WFD_3DVIDEO_FORMATS_SUBELEM_ID = 4,
	WFD_CONTENT_PROTECTION_SUBELEM_ID = 5,
	WFD_COUPLED_SINK_INFO_SUBELEM_ID = 6,
	WFD_EXTENDED_CAPAB__SUBELEM_ID = 7,
	WFD_LOCAL_IP_ADDRESS_SUBELEM_ID = 8,
	WFD_SESSION_INFO_SUBELEM_ID = 9
};
