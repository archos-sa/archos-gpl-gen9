...
E2FSPROGS_RM$(BR2_PACKAGE_E2FSPROGS_E2FREEFRAG) += ${TARGET_DIR}/sbin/e2freefrag
...
ifneq ($(BR2_PACKAGE_E2FSPROGS_TUNE2FS_STATIC),y)
	rm -rf ${TARGET_DIR}/sbin/tune2fs.static
endif
