...
ncurses-clean:
	...
	rm -f $(STAGING_DIR)/lib/libform.so* $(TARGET_DIR)/lib/libform.so*
	rm -f $(STAGING_DIR)/lib/libpanel.so* $(TARGET_DIR)/lib/libpanel.so*
	rm -f $(STAGING_DIR)/lib/libmenu.so* $(TARGET_DIR)/lib/libmenu.so*
